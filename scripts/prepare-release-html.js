...
const protectedPages = ["acessos.html","arquivos.html","caixa.html","clientes.html","compartilhar-documento.html","dashboard-comercial.html","loading.html","medicao-obra.html","nota-servico.html","orcamento-inteligente.html","orcamento.html","produtos.html","projetos.html"];
for (const name of protectedPages) {
  ...
  if (!html.includes("rk-loading-critical.css")) html = html.replace(marker, '$1\n    <link rel="stylesheet" href="../css/rk-loading-critical.css?v=1.0.2">\n    <script src="../js/shared/rk-loading.js?v=1.0.2"></script>');

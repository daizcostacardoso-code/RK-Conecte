(function (global, document) {
  ...
  function project() {
    ...
    if (title.includes("bps")) return { company: "BPS Rent a Car", logo: "../assets/conecte-logo.png" };
    if (title.includes("maiquele") || title.includes("mm conecte") || document.querySelector(".cliente-body, .admin-body")) return { company: "Maiquele Martins Nail Designer", logo: "../assets/conecte-logo.png" };
    if (title.includes("rk") || title.includes("vidra")) return { company: "RK Vidraçaria", logo: "../assets/conecte-logo.png" };
    return { company: "Conecte", logo: "../assets/logo/conecte-logo.png" };
  }

const OrcamentoItemConfig = {
    ...
    grupos: Object.freeze({
        porta: {
            ...
            tamanhosPadrao: [
                { id: "80x210", nome: "80 x 210 cm", larguraCm: 80, alturaCm: 210 },
                { id: "90x210", nome: "90 x 210 cm", larguraCm: 90, alturaCm: 210 },
                { id: "100x210", nome: "100 x 210 cm", larguraCm: 100, alturaCm: 210 }
            ],
            tipos: [
                {
                    id: "porta_abrir",
        ...
        janela: {
            ...
            tamanhosPadrao: [
                ...
                { id: "120x100", nome: "120 x 100 cm", larguraCm: 120, alturaCm: 100 },
                { id: "150x110", nome: "150 x 110 cm", larguraCm: 150, alturaCm: 110 },
                { id: "200x120", nome: "200 x 120 cm", larguraCm: 200, alturaCm: 120 }
            ],
            tipos: [
                {
                    id: "janela_correr",
        ...
        box: {
            ...
            tamanhosPadrao: [
                { id: "120x190", nome: "120 x 190 cm", larguraCm: 120, alturaCm: 190 },
                { id: "140x190", nome: "140 x 190 cm", larguraCm: 140, alturaCm: 190 },
                { id: "160x190", nome: "160 x 190 cm", larguraCm: 160, alturaCm: 190 }
            ],
            tipos: [
                {
                    id: "box_frontal",

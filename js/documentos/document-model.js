const DocumentModel = {
    ...
    empresaPadrao: {
        ...
        email: "rkvidracaria@outlook.com",
    ...
    normalizarProjeto(projeto = {}) {
        return {
            ...
            nome: this.texto(projeto.nome || projeto.titulo || projeto.descricao || projeto.obra?.nome),
            ...
            observacoes: this.texto(projeto.observacoes || projeto.descricao)
        };
    },
    ...
    normalizarProduto(produto = {}, indice = 0) {
        ...
        return {
            ...
            valorUnitario,
            valorAdicional: this.numero(produto.valorAdicional, 0),
            descricaoAdicional: this.texto(produto.descricaoAdicional),
            valorAluminio: this.numero(produto.valorAluminio, 0),
            totalAluminio: this.numero(produto.totalAluminio, 0),
            valorJato: this.primeiroNumero(produto, ["valorJato", "adicionalJato"], 0),
    ...
    normalizarTotais(totais = {}) {
        ...
        return {
            subtotal,
            totalAdicionais: this.numero(totais.totalAdicionais, 0),
            totalAluminio: this.numero(totais.totalAluminio, 0),
            totalJato: this.numero(totais.totalJato, 0),
            desconto,
            acrescimo,

const DocumentValidator = {
    validar(documento = {}) {
        ...
        this.validarProjeto(modelo.projeto, erros);
    ...
    validarProjeto(projeto = {}, erros = []) {
        if (!projeto || (!projeto.id && !projeto.numero && !projeto.nome)) {
            erros.push("Projeto e obrigatorio para gerar o Documento Comercial.");
        }
    },

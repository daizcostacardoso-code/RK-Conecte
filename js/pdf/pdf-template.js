const PdfTemplate = {
    ...
    montarResumoProjeto(modelo = {}) {
        return {
            ...
            campos: [
                { rotulo: "Projeto", valor: modelo.projeto?.nome || modelo.projeto?.numero || "" },
                { rotulo: "Status", valor: modelo.projeto?.status || "" },
                { rotulo: "Endereco da obra", valor: modelo.projeto?.endereco || "" },

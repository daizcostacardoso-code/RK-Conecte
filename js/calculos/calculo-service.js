const CalculoService = {
    ...
    validarItens(dados = {}) {
        ...
        itens.forEach((item, indice) => {
            ...
            const percentualEngenharia = CalculoModel.numero(item.percentualEngenharia, 0);
            ...
            if (percentualEngenharia < 0) {
                erros.push(`Item ${numeroItem}: adicional de engenharia nao pode ser negativo.`);
            }
        });

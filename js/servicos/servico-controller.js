const ServicoController = {
    ...
    async garantirProdutosBase() {
        ...
        if (typeof CriarProdutoUseCase !== "undefined") {
            await Promise.all(bases.map(produto => CriarProdutoUseCase.executar(produto, ProdutoService)));
            return true;
        }

        await Promise.all(bases.map(produto => ProdutoService.criarProduto(produto)));
        return true;
    },
    ...
    async salvarServico(dados = {}) {
        ...
        ServicoUI.mostrarAviso(dados.id ? "Servico atualizado com sucesso." : "Servico cadastrado com sucesso.", "sucesso");
    ...
    async inativarServico(id) {
        ...
        ServicoUI.mostrarAviso("Servico inativado.", "sucesso");
        await this.listarServicos(ServicoUI.obterFiltros());
        ...
        return [
            {
                ...
                tamanhosPadrao: [
                    this.tamanho("porta_abrir_80x210", "Porta de abrir", "80 x 210 cm", 80, 210),
                    this.tamanho("porta_abrir_90x210", "Porta de abrir", "90 x 210 cm", 90, 210),
                    this.tamanho("porta_abrir_100x210", "Porta de abrir", "100 x 210 cm", 100, 210),
                    this.tamanho("porta_correr_120x210", "Porta de correr", "120 x 210 cm", 120, 210),
                    this.tamanho("porta_correr_150x210", "Porta de correr", "150 x 210 cm", 150, 210),
                    this.tamanho("porta_correr_180x210", "Porta de correr", "180 x 210 cm", 180, 210),
                    this.tamanho("janela_2_100x100", "Janela 2 folhas", "100 x 100 cm", 100, 100),
                    this.tamanho("janela_2_120x100", "Janela 2 folhas", "120 x 100 cm", 120, 100),
                    this.tamanho("janela_2_150x110", "Janela 2 folhas", "150 x 110 cm", 150, 110),
                    this.tamanho("janela_4_200x110", "Janela 4 folhas", "200 x 110 cm", 200, 110),
                    this.tamanho("janela_4_250x120", "Janela 4 folhas", "250 x 120 cm", 250, 120),
                    this.tamanho("janela_4_300x120", "Janela 4 folhas", "300 x 120 cm", 300, 120),
                    this.tamanho("box_frontal_120x190", "Box frontal", "120 x 190 cm", 120, 190),
                    this.tamanho("box_frontal_140x190", "Box frontal", "140 x 190 cm", 140, 190),
                    this.tamanho("box_frontal_160x190", "Box frontal", "160 x 190 cm", 160, 190)
                ],
                ativo: true
            },
            ...
            this.servicoMacro("srv_macro_medicao", "Medicao tecnica", "medicao_tecnica", "Visita para conferencia de medidas e viabilidade tecnica.", [
                this.tipoServico("medicao_box", "Medicao tecnica de box", "Medicao detalhada para box.", 1, ["Instalacao"], "Registrar largura, altura, prumo, esquadro e pontos hidraulicos."),

const ServicoService = {
    ...
    async criarServico(dados = {}) {
        try {
            ...
            return this.respostaErro(erro, "Erro ao criar item.");
        }
    },
        ...
        try {
            if (!id) {
                return {
                    sucesso: false,
                    servico: null,
                    erros: ["Id do item e obrigatorio."]
                };
            }
            ...
            return {
                sucesso: !!servico,
                servico,
                erros: servico ? [] : ["Item nao encontrado."]
            };
        } catch (erro) {
            return this.respostaErro(erro, "Erro ao buscar item.");
        }
    },
    ...
    async listarServicos(filtros = {}) {
        try {
            ...
            return {
                sucesso: false,
                servicos: [],
                erros: [erro.message || "Erro ao listar itens."]
            };
        }
    },
    ...
    async atualizarServico(id, alteracoes = {}) {
        try {
            ...
            return this.respostaErro(erro, "Erro ao atualizar item.");
        }
    },
    ...
    async desativarServico(id) {
        try {
            ...
            return this.respostaErro(erro, "Erro ao desativar item.");
        }
    },
